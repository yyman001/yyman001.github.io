...
function createAce() {
	...
	loader.add("img/ace/lightning1.png");
	loader.add("img/ace/lightning2.png");
	loader.add("img/ace/lightning3.png");
	loader.add("img/ace/lightning4.png");
	loader.add("img/ace/lightning5.png");
	loader.add("img/ace/lightning6.png");
	loader.add("img/ace/lightning7.png");
	loader.add("img/ace/lightning8.png");
	loader.add("img/ace/lightning9.png");
	...
	function onAssetsLoaded() {
		...
		aceTitle = new PIXI.Text("ACE", { font: "150px Knockout47", fill: "#ffffff", padding: 15 });
