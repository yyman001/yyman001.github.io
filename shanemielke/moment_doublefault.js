...
function createDoubleFault() {
	momentDoubleFault = new PIXI.Container();
	...
	function onAssetsLoaded() {
		...
		//////////////// PARTICLE STUFF /////////////////
		doubleFaultParticleContainer = new PIXI.Container();
		...
		if (matchVizViewConfig.isWebGL) doubleFaultCircle1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		momentDoubleFault.addChild(doubleFaultCircle1);
		
		doubleFaultCircle2 = new PIXI.Graphics();
		if (matchVizViewConfig.isWebGL) doubleFaultCircle2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 30; i++) {
			...
			if (matchVizViewConfig.isWebGL) doubleFaultParticle.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 4; i++) {
			...
			if (matchVizViewConfig.isWebGL) doubleFaultAngle.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 2; i++) {
			...
			if (matchVizViewConfig.isWebGL) doubleFaultRectangle.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) doubleFaultShardBig1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) doubleFaultShardBig2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) doubleFaultShardMini1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) doubleFaultShardMini2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		momentDoubleFault.addChild(doubleFaultShardMini2);
		
		// TEXT
		doubleFaultTitle1 = new PIXI.Text("DOUBLE", { font: "90px Knockout47", fill: "#ffffff", align: "center", padding: 15 });
		doubleFaultTitle1.anchor.x = 0.5;
		doubleFaultTitle1.anchor.y = 0.35;
		momentDoubleFault.addChild(doubleFaultTitle1);
		
		doubleFaultTitle2 = new PIXI.Text("FAULT", { font: "90px Knockout47", fill: "#ffffff", align: "center", padding: 15 });
		doubleFaultTitle2.anchor.x = 0.5;
		doubleFaultTitle2.anchor.y = 0.35;
...
function explodeDoubleFault() {
	...
	doubleFaultAnimationIn.add(TweenMax.fromTo( doubleFaultTitle1, 1,{ x: 0, y: 0, scaleX: 0, scaleY: 0 },{ x: 0, y: -35, scaleX: 1, scaleY: 1, ease: Elastic.easeOut }), 3.25);
	doubleFaultAnimationIn.add(TweenMax.fromTo( doubleFaultTitle1, 1,{ alpha: 0 },{ alpha: 1, ease: Expo.easeOut }), 3.25);
	
	doubleFaultAnimationIn.add(TweenMax.fromTo( doubleFaultTitle2, 1.1,{ x: 0, y: 0, scaleX: 0, scaleY: 0 },{ x: 0, y: 35, scaleX: 1, scaleY: 1, ease: Elastic.easeOut }), 3.25);
	doubleFaultAnimationIn.add(TweenMax.fromTo( doubleFaultTitle2, 1.1,{ alpha: 0 },{ alpha: 1, ease: Expo.easeOut }), 3.25);
