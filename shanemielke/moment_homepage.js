...
function createHomepage() {
	momentHomepage = new PIXI.Container();
	momentGroup.addChild(momentHomepage);
	
	var loader = new PIXI.loaders.Loader();
	loader.add("img/homepage/angle-white.png");
	loader.add("img/homepage/shard3-white.png");
	loader.add("img/homepage/glow.png");
	loader.add("img/homepage/triangle2-white.png");
	loader.add("img/homepage/logo.png");
	...
	function onAssetsLoaded() {
		...
		//////////////// PARTICLE STUFF /////////////////
		homepageParticleContainer = new PIXI.Container();
		...
		// SWARMING ARROWS
		homepageSwarmContainer1 = new PIXI.Container();
		homepageSwarmContainer2 = new PIXI.Container();
		homepageSwarmArray = [];
		...
		homepageLeftWrapper = new PIXI.Container();
			homepageLeftInner = new PIXI.Container();
				homepageLeftGroup1 = new PIXI.Container();
					...
					homepageLeftAngle1_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
					...
					homepageLeftAngle1_2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
					homepageLeftGroup1.addChild(homepageLeftAngle1_2);
				homepageLeftInner.addChild(homepageLeftGroup1);
					
				homepageLeftGroup2 = new PIXI.Container();
					// BLUE ANGLE 1
					...
					homepageLeftAngle2_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
					...
					homepageLeftAngle2_2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		// RIGHT ANGLES
		homepageRightWrapper = new PIXI.Container();
			homepageRightInner = new PIXI.Container();
				homepageRightGroup1 = new PIXI.Container();
					...
					homepageRightAngle1_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
				...
				homepageRightGroup2 = new PIXI.Container();
					...
					homepageRightAngle2_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
					...
					homepageRightAngle2_2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		// LEFT ANGLES V2
		homepageLeft2Wrapper = new PIXI.Container();
			homepageLeft2Inner = new PIXI.Container();
				homepageLeft2Group1 = new PIXI.Container();
					...
					homepageLeft2Angle1_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
				...
				homepageLeft2Group2 = new PIXI.Container();
					...
					homepageLeft2Angle2_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
					...
					homepageLeft2Angle2_2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		// RIGHT ANGLES
		homepageRight2Wrapper = new PIXI.Container();
			homepageRight2Inner = new PIXI.Container();
				homepageRight2Group1 = new PIXI.Container();
					...
					homepageRight2Angle1_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
				...
				homepageRight2Group2 = new PIXI.Container();
					...
					homepageRight2Angle2_1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
					...
					homepageRight2Angle2_2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
