...
function createMatchPoint() {
	momentMatchPoint = new PIXI.Container();
	momentGroup.addChild(momentMatchPoint);
	
	var loader = new PIXI.loaders.Loader();
	loader.add("img/matchpoint/octagon.png");
	loader.add("img/matchpoint/bar.png");
	loader.add("img/matchpoint/bar2.png");
	loader.add("img/matchpoint/stripes.png");
	loader.add("img/matchpoint/bar-piece1.png");
	loader.add("img/matchpoint/bar-piece2.png");
	loader.add("img/matchpoint/bar-piece3.png");
	loader.add("img/matchpoint/lightning1.png");
	loader.add("img/matchpoint/lightning2.png");
	loader.add("img/matchpoint/lightning3.png");
	loader.add("img/matchpoint/lightning4.png");
	loader.add("img/matchpoint/bar-swirl1.png");
	loader.add("img/matchpoint/bar-swirl2.png");
	...
	function onAssetsLoaded() {
		...
		//////////////// PARTICLE STUFF /////////////////
		matchPointParticleContainer = new PIXI.Container();
		...
		if (matchVizViewConfig.isWebGL) matchPointSwirl1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) matchPointSwirl2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) matchPointStripes.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) matchPointOctagonMini.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) matchPointOctagonMini2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		momentMatchPoint.addChild(matchPointOctagonMini2);

		// CREATE THE SHARD PIECES AND BARS
		matchPointBar1 = new PIXI.Container();
		matchPointBar2 = new PIXI.Container();
		matchPointBar3 = new PIXI.Container();
		...
		for (var i = 0; i < 3; i++) {
			...
			if (matchVizViewConfig.isWebGL) matchPointBarPiece1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
			if (matchVizViewConfig.isWebGL) matchPointBarPiece2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
			if (matchVizViewConfig.isWebGL) matchPointBarPiece3.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 5; i++) {
			var matchPointOctagonContainer = new PIXI.Container();
			...
			if (matchVizViewConfig.isWebGL) matchPointOctagon.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 60; i++) {
			...
			if (matchVizViewConfig.isWebGL) matchPointParticle.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) matchPointLightning1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) matchPointLightning2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) matchPointLightning3.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) matchPointLightning4.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 4; i++) {
			...
			if (matchVizViewConfig.isWebGL) matchPointAngle.blendMode = PIXI.BLEND_MODES.MULTIPLY;
			momentMatchPoint.addChild(matchPointAngle);
			matchPointAngleArray.push(matchPointAngle);
		}
		
		// TEXT
		matchPointTitle = new PIXI.Text("MATCH", { font: "120px Knockout47", fill: "#ffffff", align: "center", padding: 15 });
		matchPointTitle.anchor.x = 0.5;
		matchPointTitle.anchor.y = 0.35;
...
function explodeMatchPoint() {
	...
	matchPointAnimationIn.add(TweenMax.fromTo( matchPointTitle, 1,{ x: 0, y: 0, scaleX: 0, scaleY: 0 },{ x: 0, y: 0, scaleX: 1, scaleY: 1, ease: Elastic.easeOut }), 3);
	matchPointAnimationIn.add(TweenMax.fromTo( matchPointTitle, 1,{ alpha: 0 },{ alpha: 1, ease: Expo.easeOut }), 3);
