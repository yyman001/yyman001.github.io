...
function createBreakPoint() {
	momentBreakPoint = new PIXI.Container();
	momentGroup.addChild(momentBreakPoint);
	
	var loader = new PIXI.loaders.Loader();
	loader.add("img/breakpoint/color1shard1.png");
	loader.add("img/breakpoint/color1shard2.png");
	loader.add("img/breakpoint/color1shard3.png");
	loader.add("img/breakpoint/color1shard4.png");
	loader.add("img/breakpoint/color1shard5.png");
	loader.add("img/breakpoint/color1shard6.png");
	loader.add("img/breakpoint/color1shard7.png");
	loader.add("img/breakpoint/color1shard8.png");
	loader.add("img/breakpoint/color2shard1.png");
	loader.add("img/breakpoint/color2shard2.png");
	loader.add("img/breakpoint/color2shard3.png");
	loader.add("img/breakpoint/explosion1.png");
	loader.add("img/breakpoint/explosion2.png");
	loader.add("img/breakpoint/explosion3.png");
	loader.add("img/breakpoint/explosion4.png");
	loader.add("img/breakpoint/explosion5.png");
	loader.add("img/breakpoint/explosion6.png");
	loader.add("img/breakpoint/explosion7.png");
	loader.add("img/breakpoint/explosion8.png");
	loader.add("img/breakpoint/explosion9.png");
	loader.add("img/breakpoint/explosion10.png");
	loader.add("img/breakpoint/explosion11.png");
	loader.add("img/breakpoint/explosion12.png");
	loader.add("img/breakpoint/explosion13.png");
	...
	function onAssetsLoaded() {
		...
		//////////////// PARTICLE STUFF /////////////////
		breakPointParticleContainer = new PIXI.Container();
		...
		for (var i = 0; i < 45; i++) {
			...
			if (matchVizViewConfig.isWebGL) breakPointParticleFlying.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor1Shard1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor1Shard2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor1Shard3.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor1Shard4.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor1Shard5.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor1Shard6.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor1Shard7.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor1Shard8.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor2Shard1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor2Shard2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointColor2Shard3.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointFloor.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointBall1.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointBall2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointBall3.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointBall4.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		if (matchVizViewConfig.isWebGL) breakPointBall5.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 30; i++) {
			...
			if (matchVizViewConfig.isWebGL) breakPointParticleTri.blendMode = PIXI.BLEND_MODES.MULTIPLY;
		...
		for (var i = 0; i < 13; i++) {
			...
			if (matchVizViewConfig.isWebGL) breakPointExplosion.blendMode = PIXI.BLEND_MODES.MULTIPLY;
...
function explodeBreakPoint() {
	...
	breakPointAnimationIn.add(TweenMax.fromTo( breakPointTitle1, 1,{ x: 0, y: 0, scaleX: 0, scaleY: 0 },{ x: 0, y: -80, scaleX: 1, scaleY: 1, ease: Elastic.easeOut }), 3.25);
	breakPointAnimationIn.add(TweenMax.fromTo( breakPointTitle1, 1,{ alpha: 0 },{ alpha: 1, ease: Expo.easeOut }), 3.25);
	
	breakPointAnimationIn.add(TweenMax.fromTo( breakPointTitle2, 1.1,{ x: 0, y: 0, scaleX: 0, scaleY: 0 },{ x: 0, y: 0, scaleX: 1, scaleY: 1, ease: Elastic.easeOut }), 3.25);
	breakPointAnimationIn.add(TweenMax.fromTo( breakPointTitle2, 1.1,{ alpha: 0 },{ alpha: 1, ease: Expo.easeOut }), 3.25);
